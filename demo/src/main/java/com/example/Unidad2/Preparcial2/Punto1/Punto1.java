package com.example.Unidad2.Preparcial2.Punto1;
...
/*
 Cree un método que reciba como parámetro una Lista Simple 
 y retorne la misma Lista, pero invertida, use Pilas.
 */
...
class Pila<T extends Comparable<? super T>> {
    ...
    public void invertirLista(/* ClaseLista nombreLista */ ) {
